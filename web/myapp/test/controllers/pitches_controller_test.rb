...
class PitchesControllerTest < ActionController::TestCase
  ...
  test "should create pitch" do
    assert_difference('Pitch.count') do
      post :create, pitch: { description: @pitch.description, name: @pitch.name, user_id: @pitch.user_id }
    end
  ...
  test "should update pitch" do
    patch :update, id: @pitch, pitch: { description: @pitch.description, name: @pitch.name, user_id: @pitch.user_id }
    assert_redirected_to pitch_path(assigns(:pitch))
  end
